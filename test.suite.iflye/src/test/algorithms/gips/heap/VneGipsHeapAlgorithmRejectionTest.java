...
/**
 * Test class for the VNE GIPS heap algorithm implementation for rejecting VNs
 * that can not be embedded properly.
 *
 * @author Maximilian Kratz {@literal <maximilian.kratz@es.tu-darmstadt.de>}
 */
public class VneGipsHeapAlgorithmRejectionTest extends VneGipsAlgorithmRejectionTest {
