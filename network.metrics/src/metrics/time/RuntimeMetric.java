...
/**
 * Runtime metric implementation. This one has a start and an end time stamp and
 * calculates the amount of time between them.
 *
...
public class RuntimeMetric implements IMetric {
	...
	/**
	 * Creates a new instance of this metric. The time of creation will be used as
	 * starting time stamp.
	 */
