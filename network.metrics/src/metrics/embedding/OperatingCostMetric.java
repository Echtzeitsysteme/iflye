...
/**
 * Operating cost metric implementation. This metric calculates the operating costs of the whole
 * substrate network based on: The number of used substrate servers, the number of used substrate
 * switches and the amount of used resources per substrate server.
 * 
...
public class OperatingCostMetric implements IMetric {
  ...
  public OperatingCostMetric(final SubstrateNetwork sNet) {
    ...
    final Set<SubstrateSwitch> forwardingSwitches = new HashSet<SubstrateSwitch>();
