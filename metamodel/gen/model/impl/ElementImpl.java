 ...
 *   <li>{@link model.impl.ElementImpl#getStatus <em>Status</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ElementImpl extends EObjectImpl implements Element {
	...
	public void setStatus(Status newStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ELEMENT__STATUS, oldStatus, status));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ModelPackage.ELEMENT__NAME:
			return getName();
		case ModelPackage.ELEMENT__STATUS:
			return getStatus();
		}
