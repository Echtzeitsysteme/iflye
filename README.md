...
* Import all projects related to [eMoflon-ILP](https://github.com/eMoflon/emoflon-ilp) into your development workspace. Build the project using the Maven Eclipse integration.
