 ...
 * If it does not, the algorithm is unable to embed the request.
 * The resources are added all together.
 * 
...
public class SimpleVne {
	...
	public static boolean execute(final String substrateId, final String virtualId) {
		...
		for (Node actNode : subServers) {
			...
			final int resSum = actServer.getResidualCpu() 
					+ actServer.getResidualMemory() 
