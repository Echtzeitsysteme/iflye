 ...
 * approach that first tries to embed a whole virtual network onto a substrate rack B.
 * 
...
public class VnePmMdvneAlgorithmPipelineTwoStagesRackB extends VnePmMdvneAlgorithm {
   ...
   */
  protected VnePmMdvneAlgorithmPipelineTwoStagesRackB(final SubstrateNetwork sNet,
