 ...
 * to reduce the search space of the ILP solver. This implementation embeds whole virtual networks
 * onto substrate servers only.
 * 
...
public class VnePmMdvneAlgorithmPipelineStageVnet extends VnePmMdvneAlgorithm {
   ...
   */
  protected VnePmMdvneAlgorithmPipelineStageVnet(final SubstrateNetwork sNet,
