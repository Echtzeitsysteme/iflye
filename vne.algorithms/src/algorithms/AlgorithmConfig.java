...
public class AlgorithmConfig {
	...
	public enum Objective {
		 ...
		 *
		 * [3] Meng, Xiaoqiao, Vasileios Pappas, and Li Zhang. "Improving the
		 * scalability of data center networks with traffic-aware virtual machine
		 * placement." 2010 Proceedings IEEE INFOCOM. IEEE, 2010.
		 *
		 * [4] M. G. Rabbani, R. P. Esteves, M. Podlesny, G. Simon, L. Z. Granville and
		 ...
		 * 2013, pp. 177-184.
		 *
		 * [5] As in [3,4] but with node cost that decreases if a substrate server gets
		 * filled up.
		 *
		 * [6] As in [5] but with inverted node cost.
		 *
		 * [7] Zeng, D., Guo, S., Huang, H., Yu, S., and Leung, V. C.M., “Optimal VM
	...
	/**
	 * If true, the {@link VnePmMdvneAlgorithm} will create additional SOS1
	 * constraints for each virtual element to map. This may give the ILP solver a
	 * head-start to solve the problem.
	 */
	public static boolean pmSosEnabled = true;

	/**
	 * Number of how often the {@link VnePmMdvneAlgorithmMigration} should try to
	 * achieve a valid embedding while using the migration functionality. Must at
	 * least be set to 1.
	 */
	public static int pmNoMigrations = 6;

	/**
	 * If true, the network rejection cost will be calculated based on the size of
	 * the virtual network and its resources. If false, the cost will be static.
	 */
