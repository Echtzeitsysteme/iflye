...
public class VnePmMdvneAlgorithmMigrationTest {
  ...
  public void testNoMigration() {
    ...
    testSetupAndCheck(60, 0);
  }

  @Test
  public void testAlwaysFreeMigration() {
    AlgorithmConfig.mig = Migration.ALWAYS_FREE;
    testSetupAndCheck(6, 1);
  }
   ...
   */
  private void testSetupAndCheck(final int totalComCostARef, final int vsw3DepthRef) {
