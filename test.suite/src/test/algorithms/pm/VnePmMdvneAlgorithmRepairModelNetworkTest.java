...
/**
 * Test class for the VNE pattern matching algorithm implementation for repairing a removed virtual
 * network in the model. This test should trigger the algorithm to repair the substrate network
 * information after a ungraceful removal of a previously embedded virtual network.
 * 
...
public class VnePmMdvneAlgorithmRepairModelNetworkTest extends AAlgorithmTest {
  ...
  public void restoreConfig() {
    // This method has to overwrite the method from super class, because we do not want to validate
    // the model after each test. This is the case, because some tests intentionally left the model
  ...
  public void testConsistentModelAfterRepair() {
    ...
    // Validation must pass to show that the algorithm repaired the model of the substrate network
    facade.validateModel();
  }
