...
/**
 * Test class for the ModelFacade that tests two tier path related creations with large scale
 * scenarios. This tests do only check the number of created paths.
 * 
...
public class ModelFacadePathLargeScaleTest {
  ...
  /**
   * Returns the number of paths for a two tier network with given parameters. This calculation is
   * only correct, if the minimum (maximum) path length is set to 1 (4).
   * 
