...
import rules.api.RulesDemoclesApp;

/**
 * Wrapper class for initializing the Rules Democles App pattern matcher.
 * 
 ...
 */
public class EmoflonPatternMatcherDemoclesApp extends RulesDemoclesApp {
   ...
   */
  public EmoflonPatternMatcherDemoclesApp(final Root root) {
